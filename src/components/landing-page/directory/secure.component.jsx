    ...
    <Fragment>
        <div className="bg-[#080A0C] bg-[url('/src/assets/whyBackground.png')] text-white px-4 py-5 xl:px-32 lg:px-24 lg:py-[80px] bg-center bg-cover ">
            ...
            <div className='flex flex-wrap justify-evenly items-center w-full'>
                ...
                <div className='flex flex-col ju flex-wrap mx-2 mb-4 rounded-2xl border-2 border-[#3D8DFF] md:w-[40%] sm:w-full sm:h-auto h-auto lg:w-[31%] md:h-[240px] items-start justify-start px-7 py-3'>
                <img src={secureKey} alt="" />
