        ...
        <div>
            <Header>
                <div className="lg:px-32 lg:py-[82px] md:px-20 md:py-10 py-6 text-center px-7  flex flex-col justify-between items-center bg-[#080A0C] bg-[url('/src/assets/sectionBackground.png')] bg-cover bg-center text-white">
                    ...
                    <br /><br />
                    Mooncod makes available particular software services, including Mooncod mobile wallet application and web app version (the "Wallet" or the "App"). The Wallet enables users to (i) store locally on their own devices, tokens, cryptocurrencies and other crypto or blockchain-based digital assets (collectively, "Digital Assets"); (ii) link to decentralised applications, including, without limitation, decentralised exchanges (collectively "Dapp(s)"); (iii) from the App user interface, swap assets on a w; (iv) view addresses and information that are part of digital asset networks and broadcast transactions; and (v) additional functionality as may be added to the App from time to time (collectively the "Services").
                    <br /> <br />
